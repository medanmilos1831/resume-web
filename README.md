...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/3u4gPNnqoG)
...
```sh
npx nx serve resume-web
```

To create a production bundle:

```sh
npx nx build resume-web
```

To see all available targets to run for a project, run:

```sh
npx nx show project resume-web
```
